...
#ifndef HIDRO_ROS2_UTILS__SRV__DETAIL__TRANSITION_COMMAND__FUNCTIONS_H_
#define HIDRO_ROS2_UTILS__SRV__DETAIL__TRANSITION_COMMAND__FUNCTIONS_H_
...
#include "hidro_ros2_utils/msg/rosidl_generator_c__visibility_control.h"

#include "hidro_ros2_utils/srv/detail/transition_command__struct.h"

/// Initialize srv/TransitionCommand message.
/**
...
/// Create srv/TransitionCommand message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hidro_ros2_utils__srv__TransitionCommand_Request__init().
...
/// Destroy srv/TransitionCommand message.
/**
 * It calls
 * hidro_ros2_utils__srv__TransitionCommand_Request__fini()
...
/// Check for srv/TransitionCommand message equality.
/**
...
/// Copy a srv/TransitionCommand message.
/**
...
/// Initialize array of srv/TransitionCommand messages.
/**
...
/// Finalize array of srv/TransitionCommand messages.
/**
 * It calls
 * hidro_ros2_utils__srv__TransitionCommand_Request__fini()
...
/// Create array of srv/TransitionCommand messages.
/**
 * It allocates the memory for the array and calls
 * hidro_ros2_utils__srv__TransitionCommand_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TransitionCommand messages.
/**
 * It calls
 * hidro_ros2_utils__srv__TransitionCommand_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/TransitionCommand message array equality.
/**
...
/// Copy an array of srv/TransitionCommand messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hidro_ros2_utils__srv__TransitionCommand_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hidro_ros2_utils
...
/**
 * It calls
 * hidro_ros2_utils__srv__TransitionCommand_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hidro_ros2_utils
...
/**
 * It allocates the memory for the array and calls
 * hidro_ros2_utils__srv__TransitionCommand_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hidro_ros2_utils
...
/**
 * It calls
 * hidro_ros2_utils__srv__TransitionCommand_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HIDRO_ROS2_UTILS__SRV__DETAIL__TRANSITION_COMMAND__FUNCTIONS_H_
