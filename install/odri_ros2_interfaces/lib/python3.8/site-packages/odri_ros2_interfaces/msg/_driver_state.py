    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'odri_ros2_interfaces.msg.DriverState')
            logger.debug(
            ...
            from odri_ros2_interfaces.msg import MotorState
...
class DriverState(metaclass=Metaclass_DriverState):
    ...
    _fields_and_field_types = {
        ...
        'motor1': 'odri_ros2_interfaces/MotorState',
        'motor2': 'odri_ros2_interfaces/MotorState',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['odri_ros2_interfaces', 'msg'], 'MotorState'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['odri_ros2_interfaces', 'msg'], 'MotorState'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from odri_ros2_interfaces.msg import MotorState
        self.motor1 = kwargs.get('motor1', MotorState())
        from odri_ros2_interfaces.msg import MotorState
        self.motor2 = kwargs.get('motor2', MotorState())
    ...
    def motor1(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'motor1' field must be a sub message of type 'MotorState'"
        self._motor1 = value
    ...
    def motor2(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, MotorState), \
                "The 'motor2' field must be a sub message of type 'MotorState'"
        self._motor2 = value
