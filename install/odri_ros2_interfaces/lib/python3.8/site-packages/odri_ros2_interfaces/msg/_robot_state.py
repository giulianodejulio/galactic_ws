    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'odri_ros2_interfaces.msg.RobotState')
            logger.debug(
...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    _fields_and_field_types = {
        ...
        'motor_states': 'sequence<odri_ros2_interfaces/MotorState>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['odri_ros2_interfaces', 'msg'], 'MotorState')),  # noqa: E501
    )
