...
{
  new (message_memory) odri_ros2_interfaces::msg::DriverState(_init);
}

void DriverState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<odri_ros2_interfaces::msg::DriverState *>(message_memory);
  typed_message->~DriverState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DriverState_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(odri_ros2_interfaces::msg::DriverState, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(odri_ros2_interfaces::msg::DriverState, motor1),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(odri_ros2_interfaces::msg::DriverState, motor2),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DriverState_message_members = {
  ...
  3,  // number of fields
  sizeof(odri_ros2_interfaces::msg::DriverState),
...
get_message_type_support_handle<odri_ros2_interfaces::msg::DriverState>()
{
  return &::odri_ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::DriverState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, odri_ros2_interfaces, msg, DriverState)() {
  return &::odri_ros2_interfaces::msg::rosidl_typesupport_introspection_cpp::DriverState_message_type_support_handle;
}
