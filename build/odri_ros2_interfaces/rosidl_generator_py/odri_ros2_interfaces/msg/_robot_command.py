    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'odri_ros2_interfaces.msg.RobotCommand')
            logger.debug(
            ...
            from odri_ros2_interfaces.msg import MotorCommand
...
class RobotCommand(metaclass=Metaclass_RobotCommand):
    ...
    _fields_and_field_types = {
        ...
        'motor_commands': 'sequence<odri_ros2_interfaces/MotorCommand>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['odri_ros2_interfaces', 'msg'], 'MotorCommand')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_commands = kwargs.get('motor_commands', [])
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.motor_commands != other.motor_commands:
            return False
        return True
    ...
    def motor_commands(self):
        """Message field 'motor_commands'."""
        return self._motor_commands

    @motor_commands.setter
    def motor_commands(self, value):
        if __debug__:
            from odri_ros2_interfaces.msg import MotorCommand
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motor_commands' field must be a set or sequence and each value of type 'MotorCommand'"
        self._motor_commands = value
